...
getSymbols(ticker_sp500, src = "yahoo", from = "2018-06-11", to = "2023-06-11")

## data for NASDAQ Composite (5 years)
getSymbols(ticker_NASDAQ, src = "yahoo", from = "2018-06-11", to = "2023-06-11")

## data for Dow Jones Industrial Average (5 years)
getSymbols(ticker_dj, src = "yahoo", from = "2018-06-11", to = "2023-06-11")

## data for VIX (5 years)
getSymbols(ticker_vix, src = "yahoo", from = "2018-06-11", to = "2023-06-11")

## merge data by date (index)
All_Data <- cbind(GSPC, VIX)
...
df_vix <- select(df_all, VIX.Open, VIX.High,VIX.Low, VIX.Close)
...
addWorksheet(wb, sheetName = "df_vix")
...
writeData(wb, sheet = "df_vix", df_vix, rowNames = TRUE)
